...
namespace SpriteUtility
{
    public class Camera2D
    {
        ...
        {
            _zoomIndex = MainForm.Preferences.ZoomIndex;
            _rotation = 0.0f;
            _pos = MainForm.Preferences.CameraPos;
        ...
        {
            MainForm.Preferences.ZoomIndex = _zoomIndex;
            MainForm.Preferences.CameraPos = _pos;
